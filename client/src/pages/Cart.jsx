...
const Cart = () => {
  ...
  const getCart = () => {
    ...
    for (const key in cartItems) {
      ...
      product.quantity = cartItems[key]; //updating the quantity of main product object from cartItems like {id:quantity} in carItems
      ...
      <div className="flex-1 max-w-4xl">
        ...
        {cartArray.map((product, index) => (
          ...
          >
            ...
            {/* on icon hover remvoe from cart */}
            <div className="relative group mx-auto">
              ...
              <span
                className=" absolute -top-8 left-1/2 -translate-x-1/2  bg-primary text-white text-xs px-2 py-1 rounded  opacity-0 group-hover:opacity-100
